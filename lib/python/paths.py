...
dirs['repec_bundles'] = dirs['bundles'] + '/repec'
dirs['repec_bundles_xml'] = dirs['bundles'] + '/repec/xml'
dirs['repec_bundles_pub'] = dirs['bundles'] + '/repec/pub'
dirs['repec_bundles_cit'] = dirs['bundles'] + '/repec/cit'
dirs['repec_bundles_dis'] = dirs['bundles'] + '/repec/dis'
dirs['repec_bundles_cro'] = dirs['bundles'] + '/repec/cro'
...
dirs['group_out'] = dirs['www'] + '/groups'
dirs['groups'] = dirs['home'] + '/var/opt/groups'
dirs['tmp_group_bibdata'] = dirs['home'] + '/tmp/data'
dirs['data_cache'] = dirs['home'] + '/var/opt/cache'
...
files['records_stats'] = dirs['series_stats'] + '/records.json'
files['pdf_warcs_stats'] = dirs['series_stats'] + '/pdf_warcs.json'
files['bibfiles'] = dirs['series_stats'] + '/handles.json'
files['warcs_stats'] = dirs['series_stats'] + '/warcs.json'
files['jsons_stats'] = dirs['series_stats'] + '/json.json'
files['recika_stats'] = dirs['series_stats'] + '/recika.json'
files['futli'] = dirs['cache'] + '/spz_to_lafka.json'
files['futlis_stats'] = dirs['cache'] + '/spz_to_lafka.json'
files['disciplines'] = dirs['cache'] + '/discplines.json'
files['toc'] = dirs['input'] + '/TOC'
files['tmp_group_download_script'] = dirs['perl'] + '/20190208-script.pl'
files['langs_series'] = dirs['www'] + '/langs_series.xml'
files['stats'] = dirs['www'] + '/stats.xml'

hosts = {}
hosts['vicsync'] = '1.old.socionet.ru'

urls = {}
urls['vicsync'] = 'rsync://' + hosts['vicsync'] 
urls['toc'] = urls['vicsync'] + '/cyrcitec/TOC'
urls['groups'] = urls['vicsync'] + '/groups'
urls['group_bib_script'] = urls['vicsync'] + \
    '/cyrcitec/C2019-task1/20190208-script.pl'

xslts = {}
xslts['groups_index'] = dirs['xslt'] + '/groups_index.xslt.xml'
xslts['group_index'] = dirs['xslt'] + '/stats_cover.xslt.xml'
xslts['stats'] = dirs['xslt'] + '/stats_cover.xslt.xml'
xslts['stats_series'] = dirs['xslt'] + '/stats_series.xslt.xml'
xslts['stats_missing'] = dirs['xslt'] + '/stats_missing.xslt.xml'
xslts['itemsrecords'] = dirs['xslt'] + '/stats_group_itemsrecords.xslt.xml'
