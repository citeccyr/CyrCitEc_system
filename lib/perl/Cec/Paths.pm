...
$dirs->{'pylib'}=$dirs->{'home'}.'/lib/python';
$dirs->{'vic'}=$dirs->{'home'}.'/opt/vic';
$dirs->{'oai_convert'}=$dirs->{'vic'}.'/oai_converter';
$dirs->{'oai_structure'}=$dirs->{'oai_convert'}.'/structure';
